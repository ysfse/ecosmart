...
public class Filter implements Serializable {
    ...
    /**
     * <p>
     * Create a new Filter using a custom JPQL/HQL expression. This can be any valid where-clause type expression.
     * Reference properties by wrapping them with curly braces ({}).
     * 
     * <p>
     ...
     * <p>
     * Create a new Filter using a custom JPQL/HQL expression. This can be any valid where-clause type expression.
     * Reference properties by wrapping them with curly braces ({}). The expression can also contain place holders for
     * the Filter values; these are indicated by JPQL-style positional parameters (i.e. a question mark (?) followed by
     * a number indicating the parameter order, starting with one).
     * 
     * <p>
     * Here are some examples:
     * 
