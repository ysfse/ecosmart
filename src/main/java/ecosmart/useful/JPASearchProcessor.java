 ...
 * 
 * <p>
 * This class is designed to be used as a singleton. The constructor requires a MetadataUtil instance. Each MetadataUtil
 * instance is typically associated with a single persistence unit (i.e. EntityManagerFactory). A JPASearchProcessor can
 * only be used with EntityManagers that are associated with the same persistence unit as the MetadataUtil. If an
 * application has multiple persistence units, it will need to have multiple corresponding Search Processors.
 * 
 * @author dwolverton
 */
public class JPASearchProcessor extends BaseSearchProcessor {
    ...
    /**
     * Search for a single result using the given parameters. Uses the specified searchClass, ignoring the searchClass
     * specified on the search itself.
     */
