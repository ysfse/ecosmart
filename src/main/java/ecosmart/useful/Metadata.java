 ...
 * 
 * This interface provides a layer of abstraction between the framework and the underlying JPA provider (ex. Hibernate).
 * By switching out the implementation of this interface, the framework should be able to be used with different JPA
 * providers.
 * 
 * @author dwolverton
 */
public interface Metadata {
    ...
    /**
     * If the type is an entity return the entity name. Otherwise throw an UnsupportedOperationException.
     */
    public String getEntityName();

    /**
     * Return an array of the names of all the properties that this type has, if any. Return null if this a simple value
     * type with no properties.
     */
    public String[] getProperties();

    /**
     * Return the value of the given property of the given object of this type. Return null if this a simple value type
     * with no properties.
     */
    public Object getPropertyValue(Object object, String property);

    /**
     * Return the metadata for the given property of this type. Return null if this a simple value type with no
     * properties.
     */
    ...
    /**
     * If the type is a collection, return the Java class of the collection itself, not the Java class of it's elements
     * as with {@link #getJavaClass()}. For example: ArrayList&lt;Project&gt;, Set&lt;Person&gt;, String[].
     */
