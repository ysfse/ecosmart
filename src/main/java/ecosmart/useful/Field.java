...
public class Field implements Serializable {
    ...
    /**
     * Possible value for <code>operator</code>. This is the default value and does not apply any operator to the
     * column. All the rows in the result set are returned.
     */
    ...
    /**
     * Possible value for <code>operator</code>. This returns the sum of the given property in all rows of the result
     * set.
     */
